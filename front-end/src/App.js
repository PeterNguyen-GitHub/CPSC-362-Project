...
import { GAME_OVER_VIEW, GAME_VIEW, HOME_VIEW, SCORES_VIEW, DIFFICULTY_VIEW } from './constants';
import ScoresView from './Views/Scores';
import GameOver from './Views/GameOver';
import DifficultyView from './Views/Difficulty/Difficulty';
...
function App() {
  ...
  return (
    ...
    currentView === DIFFICULTY_VIEW   && <DifficultyView setView={setView} /> ||
